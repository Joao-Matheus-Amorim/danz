...
- **Fase 3:** clientes, boards e tarefas do Meu Painel ja persistem no Supabase.
- **Fase 5:** Trello iniciado com importacao de board/listas/cards e envio
  controlado de cards.

## Ainda Fora do Corte Atual
- CRUD real de calendario, briefings, campanhas, arquivos, inbox,
  configuracoes e tarefas fora do Meu Painel.
...
- **Fase 3:** repositorios de dados por dominio; clientes, boards e tarefas do
  Meu Painel entregues, demais dominios por cortar.
